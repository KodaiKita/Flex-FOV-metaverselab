...
import net.id107.flexfov.projection.MetaverseLab;
import net.id107.flexfov.projection.Projection;
import net.minecraft.client.gui.screen.Screen;
import net.minecraft.client.gui.widget.ButtonWidget;
import net.minecraft.text.LiteralText;

public class MetaverseLabGui extends AdvancedGui {
    public MetaverseLabGui(Screen parent) {
        super(parent);
        Projection.setProjection(new MetaverseLab());
    }
